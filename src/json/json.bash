...
_grim_command_complete_params "json_find" "Find first matching item in a JSON array" "path" "where" "equals" "return"
_grim_command_complete_params "json_set" "Set a key/value in a JSON file" "file" "key" "value"
_grim_command_complete_params "json_append" "Append a JSON object to an array in a file" "file" "item"
_grim_command_complete_params "json_remove" "Remove matching items from a JSON array in a file" "file" "match" "value"
