...
tmux_pane() {
    _description "Display piped input in a tmux split pane"
    _requires tmux || return 1
...
_complete_type "tmux_popup" action
_complete_params "tmux_popup" "title" "width" "height"
_complete_type "tmux_pane" action
_complete_params "tmux_pane" "size" "horizontal"
