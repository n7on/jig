...
openssl_file_encrypt() {
    ...
    _grim_command_param_init input output password cipher=aes-256-cbc
    _grim_command_param_parse "$@"

    _grim_command_param_validate input --required --path file || return 1
    _grim_command_param_validate password --required || return 1

    _grim_command_param_default output "${input}.enc"
...
_grim_command_complete_params "openssl_file_decrypt" "input" "output" "password" "cipher"

_grim_command_complete_values "openssl_file_encrypt" "cipher" \
    "aes-256-cbc" "aes-128-cbc"
_grim_command_complete_values "openssl_file_decrypt" "cipher" \
    "aes-256-cbc" "aes-128-cbc"
